    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("quspacedragon@123!&*")
                        .setUrl("jdbc:mysql://101.132.66.101:3306/work_flow?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
...
//                         .setInclude(new String[] { "bill","dict","enterprise","goods","scan_record","staff" }) // 需要生成的表
                        ...
                        .setVersionFieldName("last_ver")
                        .setLogicDeleteFieldName("is_valid")
                ...
                new PackageConfig()
//                        .setModuleName("")
                        .setParent("com.quspacedragon.workflow")// 自定义包路径
